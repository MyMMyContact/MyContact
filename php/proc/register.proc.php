...
extract($_POST);
	...
	if($total>=1){
		...
		$inser_con="INSERT INTO `tbl_usuario` (`nombre_usuario`, `apellido1_usuario`, `apellido2_usuario`, `fechaAlta_usuario`, `correo_usuario`, `contraseña_usuario`) VALUES ('".$s_name."', '".$s_lastname1."', '".$s_lastname2."', '".$fecha."', '".$s_email."', '".$s_password."');";
		//echo $inser_con;
